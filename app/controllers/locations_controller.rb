class LocationsController < ApplicationController
  ...
  def index
      ...
      @locations = Location.all
       @json = @locations.to_gmaps4rails do |locations, marker|
        #marker.infowindow render_to_string(:partial => "/locations/infowindow", :locals => { :locations => locations})
          marker.title "#{locations.name}"
          #marker.json({ :population => locations.population})
